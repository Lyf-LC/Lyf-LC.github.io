! function() {
    ...
    function x(t) { t.x = Math.random() * i, t.y = Math.random() * r }

    function m() { o = window.devicePixelRatio || 1, i = window.innerWidth * o, r = window.innerHeight * o, n.width = i, n.height = r, a.forEach(x) }
    ...
    m(),
        ...
        }), window.addEventListener("mouseleave", function() { h = d = null })
}();
